...
public class CollectionDemo {
    ...
    public static void listDemo(){
        List<String> fruta = new LinkedList<>();
        fruta.add("manzana");
        fruta.add("mango");
        fruta.add("aguacate");
        fruta.add("melon");
        ...
        while(i.hasNext()){
            System.out.println("con iterator" + i.next());
        }

        // FORMA 2 --- FUNCIONA CON TODOS -- MENOS CON MAP
        for(String item: fruta){
            System.out.println("Primer foreach: " + item);
        }
    ...
    public static void queueDemo(){
        ...
        System.out.println(fruta.size());//59
        System.out.println(fruta);
    ...
    public static void mapDemo(){
        Map<String, Integer> frutasCalorias = new HashMap();
